...
(()=>{
const KEY='usTop50',NAME='usPlayer',URL=globalThis.UNICORN_LEADERBOARD_URL||'https://sidhulyalkar.com/api/unicorn-stampede/leaderboard';
...
const payload=()=>({name:clean(localStorage[NAME]),score:finalScore||comp(),zone,plus:!!plus,time:+timeLeft.toFixed(2),paint:+paintPct().toFixed(4),damage:+structPct().toFixed(4),chains,active:+(actT?actS/actT/6:0).toFixed(4),stuns,gates:gates(),ms:Math.round(actT*1e3),version:'0.21'});
